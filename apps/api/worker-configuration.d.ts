/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f94e2aa6d267204742aa187afa5183c3)
// Runtime types generated with workerd@1.20250507.0 2025-04-24 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		GEFAKIT_RATE_LIMITER_KV: KVNamespace;
		GEFAKIT_FEATURE_FLAGS_KV: KVNamespace;
		NODE_ENV: string;
		DATABASE_URL: string;
		NEON_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL" | "NEON_API_KEY" | "NEON_PROJECT_ID" | "BRANCH_PREFIX" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_REDIRECT_URI" | "RESEND_KEY" | "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "APP_URL">> {}
}
