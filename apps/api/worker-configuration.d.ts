/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3f98ada3a6261ddd8e28731c0f48c10e)
// Runtime types generated with workerd@1.20250424.0 2025-04-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		GEFAKIT_RATE_LIMITER_KV: KVNamespace;
		DB_ENV: "development" | "production";
		NODE_ENV: string;
		DATABASE_URL: string;
		DATABASE_URL_POOLED: string;
		TEST_DATABASE_URL: string;
		TEST_DATABASE_URL_POOLED: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DB_ENV" | "NODE_ENV" | "DATABASE_URL" | "DATABASE_URL_POOLED" | "TEST_DATABASE_URL" | "TEST_DATABASE_URL_POOLED" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_REDIRECT_URI" | "RESEND_KEY" | "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY" | "APP_URL">> {}
}
