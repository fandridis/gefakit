...
export function LoginForm({ loading }: LoginFormProps) {
    const { signInEmail, isSigningIn } = useAuth();
                        ...
                        <div className="grid gap-6">
                            ...
                            <div className="grid gap-6">
                                <form.AppForm>
                                    ...
                                    />
                                    <form.SubmitButton label="Login" loading={isSigningIn || loading} />
                                </form.AppForm>
                            </div>
